...
- **로컬마켓** — 상시주문·입고 예정 상품을 주문하고, 입금 확인 후 완료 상태를 관리하는 마켓
...
로컬마켓 상품은 장바구니에 여러 개 담아 주문자·방·침대·전화번호를 한 번만 입력하고 묶음 주문할 수 있습니다. 주문 접수 후 합계 금액을 아래 계좌로 한 번 이체하고, Master가 입금을 확인하면 장바구니 상품 전체가 함께 완료됩니다.

상시주문 상품은 당일 오후 6시까지 주문하면 다음 날 받을 수 있습니다. 가까운 지역 농부가 자신의 이름을 걸고 직접 재배한 제품을 로컬마켓까지 가져다주는 방식으로 운영합니다.
