...
export default function ClientHome({ user }: { user: GoogleUser | null }) {
  ...
  const [onboardingDraft, setOnboardingDraft] = useState({ memberType: "" as "" | "master" | "friends" | "general", masterCode: "", cohortCode: "", stayPeriod: "2주 체류", interests: [] as string[], profileVisibility: "mates" });
  ...
  useEffect(() => {
    ...
    fetch("/api/profile")
      ...
      .then((result: { profile?: { memberType?: "master" | "friends" | "general"; cohortCode?: string; stayPeriod?: string; interests?: string; profileVisibility?: string; onboardingCompletedAt?: string | null } } | null) => {
